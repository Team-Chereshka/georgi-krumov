...
@ModeratorCommand
@AdminCommand
@CommandHelper(help = "Deletes a Comment by given Id.")
@CommandExample(example = "DeleteComment|1")
public class DeleteCommentCommand implements Command {
    private static final String NoSuchCommentMessage = "There is no Comment with the given Id.";

    private static final String NO_RIGHTS_MESSAGE = "You have NO permission to delete this comment!!";

    private static final String SuccessDeleteMessage = "Successfully Deleted Comment - %s!";
    ...
    public void execute() throws IOException, InterruptedException {
        ...
        Comment commentFromDb = entityManager.getComments()
                .stream()
