...
@ModeratorCommand
@AdminCommand
@CommandHelper(help = "Edits a Post by given Id, updating its title and content.")
@CommandExample(example = "EditPost|1|New Title|New Content")
public class EditPostCommand implements Command {
    ...
    private static final String NO_RIGHTS_MESSAGE = "You have NO permission to edit this post!!";

    private static final String SuccessEditMessage = "Successfully Editted Post - %s!";
    ...
    public void execute() throws IOException, InterruptedException {
        ...
        String newTitle = this.parameters.get(1);
        String newContent = this.parameters.get(2);
